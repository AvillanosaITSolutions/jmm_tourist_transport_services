                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
                    ...
                    <div ref={leftRef} className="fade-in">
                        ...
                        <div className="mt-10 pt-8 border-t border-sky-100 flex flex-wrap gap-5">
                            <a href="tel:+639958127441" className="flex items-center gap-2 text-sm font-semibold text-[#0369a1] hover:text-[#ff3d00] transition-colors">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                0995 812 7441
                            </a>
                            <a href="https://wa.me/639972752567" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-semibold text-[#25D366] hover:opacity-80 transition-opacity">
                            ...
                            <a href="mailto:hello.jmm@gmail.com" className="flex items-center gap-2 text-sm font-semibold text-[#0369a1] hover:text-[#ff3d00] transition-colors">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
