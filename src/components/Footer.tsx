                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm">
                        ...
                        <li className="flex gap-3 items-center">
                            ...
                            <a href="tel:+639958127441" className="text-slate-500 hover:text-[#ff6b47] transition-colors">
                                0995 812 7441
                            </a>
                        </li>
                        <li className="flex gap-3 items-center">
                            ...
                            <a href="mailto:hello.jmm@gmail.com" className="text-slate-500 hover:text-[#ff6b47] transition-colors">
                                hello.jmm@gmail.com
                            </a>
                        </li>
                    </ul>
